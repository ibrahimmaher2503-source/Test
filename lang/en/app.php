...
return [
    ...
    'dashboard' => [
        ...
        'all_branches' => 'Across all branches',
        'this_branch' => 'This branch',
        'pending_review' => 'Pending review',
        'pending_review_desc' => 'Products awaiting triage',
        'total_products' => 'Total products',
        'total_products_desc' => 'In the catalog',
        'my_active_sessions' => 'My active sessions',
        'my_active_sessions_desc' => 'Assigned to you, ready to scan',
        'active_sessions' => 'Active sessions',
        'no_active_sessions' => 'No sessions in progress right now',
        'variance_overview' => 'Variance overview',
        'variance_zero' => 'Variance = 0',
        'variance_nonzero' => 'Variance ≠ 0',
        ...
        'all_time' => 'All time',
        'counting_velocity' => 'Counting velocity',
        'cumulative_scans' => 'Cumulative scans',
        'hour_n' => 'Hour :n',
    ],
