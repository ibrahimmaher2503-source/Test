...
return [
    ...
    'dashboard' => [
        'branches' => 'الفروع',
        'sessions_in_progress' => 'جلسات جارية',
        'all_branches' => 'في كل الفروع',
        'this_branch' => 'هذا الفرع',
        'pending_review' => 'بانتظار المراجعة',
        'pending_review_desc' => 'منتجات تحتاج مراجعة',
        'total_products' => 'إجمالي المنتجات',
        'total_products_desc' => 'في الكتالوج',
        'my_active_sessions' => 'جلساتي الجارية',
        'my_active_sessions_desc' => 'مُسندة إليك وجاهزة للمسح',
        'active_sessions' => 'الجلسات الجارية',
        'no_active_sessions' => 'لا توجد جلسات جارية حاليًا',
        'variance_overview' => 'نظرة عامة على الفروقات',
        'variance_zero' => 'الفرق = 0',
        'variance_nonzero' => 'الفرق ≠ 0',
        ...
        'all_time' => 'كل الوقت',
        'counting_velocity' => 'سرعة العدّ',
        'cumulative_scans' => 'المسحات التراكمية',
        'hour_n' => 'الساعة :n',
    ],
